...
MODEL_PATH = os.path.join(BASE_DIR, "models", "llm", "llama-3.2-3b-instruct-q4.gguf")

# Alternative model locations
HOME_DIR = os.path.expanduser("~")
ALT_MODEL_PATHS = [
    os.path.join(HOME_DIR, ".llama", "llama-3.2-3b-instruct-q4.gguf"),
    os.path.join(HOME_DIR, ".llama", "Llama-3.2-3B-Instruct-q4.gguf"),
    os.path.join(HOME_DIR, ".llama", "Llama-3.2-3B-Instruct", "model-q4.gguf"),
]
